      ...
      <main className="flex flex-col items-center">
        ...
        <section className="flex flex-col items-center w-full text-center px-4 py-12 gap-6">
          <div className="w-full text-center">
            ...
            <p className="text-sm pt-4">
              Estamos dispostos a ajudar você, em todas as etapas do atendimento
              psicológico, por meio de uma plataforma segura e intuitiva de
              forma simples!
            </p>
          </div>
          ...
          <div className="flex overflow-x-auto gap-2 w-full">
            ...
            />
            <Card
              src="/gifs/service-patient.gif"
              title="Fale com o Psicólogo"
            />
          </div>
        ...
        <section className="flex flex-col items-center w-full text-center px-4 py-12 gap-6 bg-s-powder-100">
          <div className="w-full text-center">
            ...
            <p className="text-sm pt-4">
              Nós, da ONG Gabriel, já impactamos centenas de vidas com o apoio
              de pessoas voluntárias prestando atendimento psicológico!
            </p>
          </div>
          ...
          <Link
            href="/user/base-info?redirectTo=/pre-psych/form-registration"
            className="w-full"
          >
        ...
        <aside className="bg-primary p-4 rounded-lg mx-4">
          <span className="font-bold">Importante:</span> Não oferecemos
          atendimento imediato para crises suicidas. Em situação de crise,{" "}
          <span className="font-bold">ligue 188 (CVV)</span> ou acesse{" "}
          <a
          ...
          . Procure o hospital mais próximo em caso de emergência.
        </aside>
        ...
        <section className="flex flex-col items-center rounded-2xl p-4 w-full gap-6">
          ...
          <Accordion type="single" collapsible className="w-full space-y-1">
            <AccordionItem
              value="item-1"
              className="bg-secondary px-8 rounded-lg"
            >
              <AccordionTrigger className="text-sm font-semibold font-raleway text-s-onyx-100">
                Como é o atendimento?
              </AccordionTrigger>
              <AccordionContent>
                <p className="text-s-onyx-100">
                  Nós, da ONG Gabriel, já impactamos centenas de vidas com o
                  apoio de pessoas voluntárias prestando atendimento
                  psicológico!
                </p>
              </AccordionContent>
            </AccordionItem>
            ...
            >
              ...
              <AccordionContent>
                <p className="text-s-onyx-100">
                  Sim, pode ser gratuito! Fazemos uma avaliação socioeconômica
                  simples no cadastro para oferecer gratuidade. Se não for o seu
                  caso, cobramos um valor social acessível. Queremos que o
                  cuidado com a saúde mental chegue a todos!
                </p>
              </AccordionContent>
            </AccordionItem>
            <AccordionItem
            ...
            >
              <AccordionTrigger className="text-sm font-semibold font-raleway text-s-onyx-100">
                Pra quem é o atendimento?
              </AccordionTrigger>
              <AccordionContent>
                <p className="text-s-onyx-100">
                  Se você busca autoconhecimento ou precisa de ajuda para lidar
                  com ansiedade, estresse, tristeza e desafios do dia a dia,
                  aqui é o lugar certo! Oferecemos apoio psicológico contínuo.
                  Lembre-se: não somos um serviço de emergência. Em crises,
                  procure um pronto-atendimento ou ligue 188 (CVV).
                </p>
              </AccordionContent>
            </AccordionItem>
            <AccordionItem
            ...
            >
              ...
              <AccordionContent>
                <p className="text-s-onyx-100">
                  Totalmente seguros! Sua privacidade é nossa prioridade. Tudo o
                  que você conversa com o psicólogo é confidencial, seguindo o
                  Código de Ética. Nossa plataforma usa tecnologias para
                  proteger seus dados e garantir um ambiente seguro para você.
                </p>
              </AccordionContent>
            </AccordionItem>
          </Accordion>
  ...
  return (
    <div className="flex flex-col items-center justify-center py-4 px-2 gap-2 min-w-28">
      <Image
        ...
        className="w-16 h-16"
      />
      <p className="font-raleway text-center text-sm text-s-charcoal-100">
        {title}
      </p>
    </div>
  );
