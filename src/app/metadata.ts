...
export const metadata: Metadata = {
  ...
  description:
    "ONG Gabriel oferece atendimento psicológico gratuito e prevenção ao suicídio. Conectamos profissionais qualificados a pessoas que precisam de apoio emocional. Agende sua consulta online agora.",
  alternates: {
  ...
  openGraph: {
    title:
      "ONG Gabriel - Atendimento Psicológico Gratuito e Prevenção ao Suicídio",
    description:
      "Oferecemos atendimento psicológico gratuito e programas de prevenção ao suicídio. Nossa plataforma conecta profissionais qualificados a pessoas que precisam de apoio emocional. Agende sua consulta online.",
  ...
  twitter: {
    ...
    title: "ONG Gabriel - Atendimento Psicológico Gratuito",
    description:
      "Oferecemos atendimento psicológico gratuito e programas de prevenção ao suicídio. Agende sua consulta online agora.",
    images: [
      {
        url: `${env.NEXT_PUBLIC_URL}/og-link-preview.jpg`,
        secureUrl: `${env.NEXT_PUBLIC_URL}/og-link-preview.jpg`,
...
export function generateOrganizationSchema() {
  return {
    ...
    description:
      "ONG dedicada ao atendimento psicológico gratuito e prevenção ao suicídio no Brasil",
...
export function generateWebsiteSchema() {
  return {
    ...
    url: env.NEXT_PUBLIC_URL,
    description:
      "Plataforma de atendimento psicológico gratuito e prevenção ao suicídio",
    inLanguage: "pt-BR",
