...
import { getValidate, ValidateProps } from "@/infra/documents";
...
const mockDocument: ValidateProps = {
  data: Buffer.concat([
    Buffer.from("%PDF-1.4"),
...
const validatePdf = getValidate("application/pdf");
